...
from gcn.common import data
from gcn.common import models
from gcn.common import utils
if HYPERPARAM_SEARCH:
    from test_tube import HyperOptArgumentParser
    from gcn.hyp_search import parse_encoder
else:
    from gcn.config import parse_encoder
from gcn.test import validation
...
def build_model(args):
    ...
    if (args.test or args.load_model) and args.model_path:
