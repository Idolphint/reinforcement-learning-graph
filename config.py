...
args['learning_rate'] = 5e-4 # type=float)
args['gamma'] = 0.39 # type=int)  #  discounted factor
args['capacity'] = 2000 # type=int)  #  replay buffer size ori=50000
args['num_iteration'] = 100000 # type=int)  #   num of  games
args['batch_size'] = 64 # type=int)  #  mini batch size
args['seed'] = 13 # type=int)
args['dropout'] = 0.3
# optional parameters
...
args['log_interval'] = 500 # type=int)  #
args['load'] = ''#'2022-06-10-12' # type=bool)  #  load model

args['render_interval'] = 150 # type=int)  #  after render_interval  the env.render() will work
args['policy_noise'] = 0.5 # type=float)
args['noise_clip'] = 0.01 # type=float)
